...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "会を主催する / 参加を申し込む",
    b: "自分たちのグループで会を募集するか、募集中の会に人数を選んで申し込みます。どちらも2名以上のグループ単位です。",
  },
  {
    n: "03",
    t: "承認されたらグループチャットへ",
...
const FAQ = [
  {
    q: "1人でも参加できますか？",
    a: `いいえ。AISEKIは${MIN_GROUP_SIZE}名以上のグループ同士でのみ会が成立します。1対1のマッチングは、システム上どうしても作れないようになっています。同伴者が当日アプリを入れていなくても、代表者が人数分の席を確保すれば参加できます。`,
  },
  {
    q: "出会い系アプリとは違うのですか？",
